      ...
      <div style={raleway} className='w3-light-grey'>
        ...
        <div className="w3-container w3-row">
          ...
          <div className="w3-col s8 w3-bar">
            <span>Welcome, <strong>Rybka</strong></span><br/>
        ...
        <div className="w3-bar-block">
          ...
          <a href="#/tournament" className="w3-bar-item w3-button w3-padding w3-blue"><i className="fa fa-users fa-fw"></i>  Tournaments</a>
          <a href="#" className="w3-bar-item w3-button w3-padding"><i className="fa fa-eye fa-fw"></i>  Teams</a>
